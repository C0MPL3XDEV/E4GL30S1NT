...
from eagleosint.display import (
    RED, GREEN, YELLOW, BLUE, PURPLE, DARK_GRAY, WHITE, LIGHT_RED,
    BG_WHITE, BG_RED, BG_GREEN, BG_YELLOW, BG_BLUE,
    SPACE_PREFIX, LINES_SEPARATOR, LOGO, display_progress,
)
...
from eagleosint.providers.network import iplocation, infoga
